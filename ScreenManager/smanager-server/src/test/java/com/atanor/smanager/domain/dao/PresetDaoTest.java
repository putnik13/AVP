...
public class PresetDaoTest extends BaseDaoTest<Preset> {
	...
	public void testInsertRecord() throws Exception {
		Preset preset = new Preset(DisplayLayout.TWOxTHREE, 6);
	...
	public void testDeleteRecord() throws Exception {
		Preset preset = new Preset(DisplayLayout.ONExONE, 1);
	...
	public void testSelect() throws Exception {
		...
		Assert.assertEquals(Integer.valueOf(6), presetFromDB.getSectionQuantity());
	...
	public void testUpdate() throws Exception {
		...
		Assert.assertEquals(Integer.valueOf(2), presetFromDB.getSectionQuantity());
	}

	public void testGetAll() {
		Preset preset1 = new Preset(DisplayLayout.ONExONE, 1);
		Preset preset2 = new Preset(DisplayLayout.ONExTWO, 2);
		Preset preset3 = new Preset(DisplayLayout.ONExTHREE, 3);
		...
		Assert.assertEquals(Integer.valueOf(1), allDisplay.get(0).getSectionQuantity());
		
		Assert.assertEquals(DisplayLayout.ONExTWO, allDisplay.get(1).getLayout());
		Assert.assertEquals(Integer.valueOf(2), allDisplay.get(1).getSectionQuantity());
		
		Assert.assertEquals(DisplayLayout.ONExTHREE, allDisplay.get(2).getLayout());
		Assert.assertEquals(Integer.valueOf(2), allDisplay.get(2).getSectionQuantity());
	}
